package com.ebravo.cpm.security;

import static com.ebravo.cpm.utils.JdbcUtils.PERMISSOES_POR_GRUPO;
import static com.ebravo.cpm.utils.JdbcUtils.PERMISSOES_POR_USUARIO;
import static com.ebravo.cpm.utils.JdbcUtils.USUARIO_POR_LOGIN;
...
@Component
public class CPMUserDetailsService implements UserDetailsService {

	private static final Logger logger = Logger.getLogger(CPMUserDetailsService.class.getSimpleName());
	...
	public UserDetails loadUserByUsername(String login) throws UsernameNotFoundException {
		...
		try {
			...
			CPMUserDetails userDetails = buscarUsuario(connection, login);
	...
	public CPMUserDetails buscarUsuario(Connection connection, String login) throws SQLException {
		...
		return new CPMUserDetails(nome, login, password, ativo);
	}
